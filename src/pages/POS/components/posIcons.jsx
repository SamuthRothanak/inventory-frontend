...
export const RotateCcw  = ({ className }) => <Icon className={className}><path d="M1 4v6h6"/><path d="M3.51 15a9 9 0 1 0 .49-4.12"/></Icon>;
export const Pencil     = ({ className }) => <Icon className={className}><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></Icon>;